                ...
                <div class=" top-pad pt-2">
                    ...
                    <form action="{{ route('login') }}" method="POST" id="add_register_form">
                        ...
                        <div class="login-form pb-5">
                            <h2 class="mt-5 pt-2 pb-3 mb-4 col-b">Login to virtual platform will be available on 5 June, 2023</h2>
                            <!--<div class="input-feilds text-center mt-3">
                                    ...
                                    <div class="  text-start ol-list">
                                        <ol>
                                            ...
                                            <li> You may watch the recorded sessions from 13 June onwards. This
                                                platform is accessible until 30 June 2023
                                            </li>
                                            <br>
                                ...
                                <!--<button type="submit" id="add_submit_btn" class="btn btn-info enter-btn mb-5 ">Download Joining Instruction</button>-->
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="programs-hexagon hexagon-4">
         ...
         <div class="programs-hexagon hexagon-6">
            ...
            <div class="program-details">
                ...
                <div class="detail ps-1 text-center">9.05 AM<br>Datuk Sazali Hamzah</div>

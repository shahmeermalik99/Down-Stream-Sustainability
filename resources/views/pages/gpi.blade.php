        ...
        <div class="container-fluid">
            <div class="data-mai">
                <div class="orange-poly">
                    <p class="geng-both ">Geng Plastik<br> Ija </p>
                </div>


                <div class="org-poly">
                    <div class="both-para">
                        <p>The group got the symbolic name of Geng Plastik Ija, a Malay translated term synonymous with the green plastic bag used by the team during plogging activities. Learn how the team spearheaded community-driven beach cleaning activities across Terengganu.<br><br>
Visit our official website at <a target="_blank" href="https://www.gengplastikija.org/home">https://www.gengplastikija.org/home</a>
            ...
            <div class="container  ">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="vid-section1 ">
                            <div class="ratio ratio-16x9 ">
                                <iframe src="https://player.vimeo.com/video/825707810?h=21898ed8f7" allowfullscreen=""
                    ...
                    <div class="item">
                        <div class="vid-section1 ">
                            <div class="ratio ratio-16x9 ">
                                <iframe src="https://player.vimeo.com/video/825707891?h=de5c80d680" allowfullscreen=""
                                    _idm_id_="681535489"></iframe>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content1">
            <div class="container  ">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil1.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil1.png')}}" alt="">
                        </a>
                    </div>
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil2.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil2.png')}}" alt="">
                        </a>
                    </div>
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil3.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil3.png')}}" alt="">
                        </a>
                    </div>
                  
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil4.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil4.png')}}" alt="">
                        </a>
                    </div>
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil5.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil5.png')}}" alt="">
                        </a>
                    </div>
                    <div class="item">
                         <a href="{{ asset('assets/images/geng-sil6.png')}}" data-lightbox="image-1" >  
                        <img loading="lazy" class="w-100" src="{{ asset('assets/images/geng-sil6.png')}}" alt="">
                        </a>
                    </div>
            ...
            <div class="container  ">
                ...
                <div class=section-pdf>
                    ...
                    <div class="d-grid gap-2 btn-d pt-4">
                      <a target="_blank" href="https://downstreamsustainability.com/assets/pdf/2.%20Laporan%20Aktiviti.pdf?dl=0" class="btn btn-primary btn-2-col " type="button">Laporan Aktiviti 2022</a>  
                      <a target="_blank" href="https://downstreamsustainability.com/assets/pdf/1.%20Tentang%20GPI%20Rev3%20Feb2023.pdf?dl=0" class="btn btn-primary btn-1-col " type="button">GPI Handbook </a>

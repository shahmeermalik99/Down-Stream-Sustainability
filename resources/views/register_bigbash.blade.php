        ...
        <div class="row ">
                    ...
                    <div class="col-lg-12 sm-6">
                        <div class="downstream-day mt-lg-3">
                            <div class="twenty-twentythree">DOWNSTREAM
                                SUSTAINABILITY
                                DAY <BR><span class="downst"> 2023</span>
                            </div>
                        </div>
                        <div class="icon-text">
          ...
          <div class="col-lg-6 sm-12 right-form ps-lg-5">
                <div class=" top-pad pt-2 ps-lg-5">
                    <form action="{{ route('registeration') }}" id="add_register_form" method="post"> 
                            <div class="login-form">
                            
                                <h2 class="mt-5 pt-2 pb-3 mb-2 col-b text-center">Registrations now</h2>
                                        ...
                                        <div class="inner-text">
                                            ...
                                            <div class="form-check ">
                                                ...
                                                <label class="form-check-label pt-1 ps-2 " for="dinner">
                                                    <span class="iner-check"> Dinner </span> (12 June, 7.00 PM)</label>
                                            </div>
                                            <div class="form-check ">
                                                ...
                                                <label class="form-check-label pt-1 ps-2" for="day_session">
                                                    <span class="iner-check"> Day 2 Sessions</span> (13 June, 9.00 AM)</label>
                                            </div>
                                        </div>
                                        <div>
